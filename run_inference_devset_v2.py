...
def main(args):
    ...
    if pipeline_version == "v2":
        # Load V2 pipeline (multi-channel + three-tower)
        print("Loading CRS Baseline V2 (multi-channel + three-tower)...")
        music_crs = load_crs_baseline_v2(
            lm_type=config.lm_type,
            conversation_dataset_name=config.get("conversation_dataset_name", "talkpl-ai/TalkPlayData-Challenge-Dataset"),
            ...
            qwen_model_path=config.get("qwen_model_path", "/home/lijiatong06/music-crs-baselines/Qwen3-Embedding-0.6B"),
