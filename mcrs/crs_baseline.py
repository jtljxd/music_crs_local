"""Conversational Recommender System baseline.
...
class CRS_BASELINE:
    ...
    LLM module, an item retrieval module (BM25 or BERT) over a music catalog
    and user profiles.

    Attributes:
        cache_dir: Local path for caching artefacts and indices.
        lm_type: Identifier/name for the LLM backend to load.
        retrieval_type: Retrieval backend to use ("bm25" or "bert").
        ...
        device: Compute device for the LLM.
    ...
    def __init__(
        ...
        Args:
            ...
            item_db_name: Dataset name for track metadata.
            user_db_name: Dataset name for user metadata.
            track_emb_db_name: Dataset name for pre-computed track embeddings (unused; kept for API compat).
            user_emb_db_name: Dataset name for pre-computed user embeddings (unused; kept for API compat).
            ...
            retrieval_topk: Number of candidates retrieved.
        """
    ...
    def chat(
        ...
        """Run a single CRS turn: retrieve → generate response.
        ...
        Returns:
            A dictionary with keys:
                ...
                - retrieval_items: Retrieved list of track IDs.
        ...
        recommend_item = self.item_db.id_to_metadata(retrieved_items[0])
    ...
    def batch_chat(
        ...
        """Run multiple CRS turns in batch: retrieve → generate.
        ...
        recommend_items = [
            self.item_db.id_to_metadata(items[0]) for items in batch_retrieved
        ]
