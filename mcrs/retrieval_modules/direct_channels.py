...
DIRECT_CHANNELS: List[Tuple[str, object, int]] = [
    ("CH01_CF_BPR",            ch01_cf_bpr,            30),
    ("CH02_Query_Meta",        ch02_query_metadata,    55),
    ("CH03_Query_Lyrics",      ch03_query_lyrics,      35),
    ("CH04_Query_Attributes",  ch04_query_attributes,  35),
    ("CH05_Goal_Meta",         ch05_goal_metadata,     45),
    ("CH06_Goal_Lyrics",       ch06_goal_lyrics,       25),
    ("CH07_Goal_Attributes",   ch07_goal_attributes,   25),
    ("CH08_Pos_Sem",           ch08_session_pos_feedback, 35),
    ("CH09_Neg_Correct",       ch09_session_neg_correction, 25),
    ("CH10_Query_Delta",       ch10_query_delta,       20),
    ("CH11_Last_Audio",        ch11_last_track_audio,  15),
    ("CH12_Last_Image",        ch12_last_track_image,  10),
    ("CH13_Last_Meta",         ch13_last_track_metadata, 15),
    ("CH14_Last_Lyrics",       ch14_last_track_lyrics, 10),
    ("CH15_Pos_Audio",         ch15_pos_audio,         15),
    ("CH16_Pos_Image",         ch16_pos_image,         10),
    ("CH17_Pos_Meta",          ch17_pos_metadata,      15),
    ("CH18_Pos_Lyrics",        ch18_pos_lyrics,        10),
    ("CH19_Pos_Attributes",    ch19_pos_attributes,    10),
    ("CH20_Artist_Expand",     ch20_artist_expand,     20),
    ("CH21_Album_Expand",      ch21_album_expand,      10),
    ("CH22_BGE_Genre_Decade",  ch22_bge_genre_decade,  25),
